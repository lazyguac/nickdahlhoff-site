---
title: Aura Finance
tagline: I ran the content and social for a DeFi protocol, mostly on my own, for two years.
status: archive
order: 5
...
A lot of it ran through purple pepe: a recurring character I used across the social images and video, so the crypto-native audience had something consistent to recognize.

One of the videos, made with AI generation end to end:

<video controls preload="none" poster="/images/aura/aura-brand-film-poster.jpg" style="max-width: 100%; border-radius: 8px;">
  <source src="/images/aura/aura-brand-film.mp4" type="video/mp4" />
</video>

## The scope, and what I got out of it

This was a long bear market for DeFi, and there were stretches where there wasn't much to say. I had no KPIs and almost no feedback, so I can't point to numbers. What I can point to is a brand that kept putting out consistent content for two years, mostly with me running it on my own.
